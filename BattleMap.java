...
public class BattleMap {
    ...
    public class HarvestersBase {

       private Vector2 position;
    //   private TextureRegion base;

       public HarvestersBase(Vector2 position){
           this.position = position;
    //       this.base = Assets.getInstance().getAtlas().findRegion("shortButton");
       }
    ...
    public HarvestersBase getHarvestersBase(){
        return harvestersBase; 
    }
